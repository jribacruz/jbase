package br.jus.tre_pa.jbase.jsf.filter;
...
/**
 * Fix para a versão 2.4.2. Evita o NullPointerException ao injetar o
 * HttpServletResponse Implements the {@link javax.servlet.Filter} interface.
 * 
 * @author SERPRO
 */
